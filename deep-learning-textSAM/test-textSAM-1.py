...
for FID in range(42):
  ...
  rutaCarpetaImagenes = os.path.join(directorioTrabajo,'Imagenes')
  ...
  print(f'Iteración nº: {FID} Número de vehículos: {numeroVehiculos}')
